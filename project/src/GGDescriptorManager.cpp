...
void DescriptorManager::CreateDescriptorPool(VkDevice device,int maxFramesInFlight)
{
...
void DescriptorManager::CreateDescriptorSets(VkImageView imageView, VkSampler sampler, int maxFramesInFlight, VkDevice device, std::vector<VkBuffer> uniformBuffers)
{
